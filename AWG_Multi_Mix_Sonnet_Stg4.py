...
# Stage 4: Complete integrated system with simultaneous operation
...
class PicoTestStation:
    ...
    # ========================================================================
    # DISPLAY FUNCTIONS WITH STAGE 4 ENHANCEMENTS
    # ========================================================================
    ...
    def display_combined_screen(self, multimeter_data, awg_data):
        ...
        waveform_short = awg_data['waveform'][:8]  # Truncate waveform name
        status = "ON" if self.awg_output_active else "OFF"
        self.oled.text(f"{waveform_short} {status}", 64, 12, 1)
    ...
    def display_stage_info(self):
        ...
        if self.stage >= 4:
            self.oled.text("Complete System", 0, 48, 1)
        else:
            self.oled.text("Menu Control", 0, 48, 1)
        self.oled.show()
    
    # ========================================================================
    # TERMINAL MENU SYSTEM - STAGE 4 COMPLETE
    # ========================================================================
    
    def show_main_menu(self):
        """Display main menu options - Stage 4 complete version"""
        print("\n" + "="*70)
        print("PICO TEST STATION - COMPLETE SYSTEM (STAGE 4)")
        print("="*70)
    ...
    def handle_menu_command(self, command):
        """Handle terminal menu commands - Stage 4 complete version"""
        if command == 'h':
            self.show_main_menu()
    ...
    def show_current_readings(self):
        """Show current sensor readings - Stage 4 enhanced version"""
        print("\n" + "-"*70)
        print("CURRENT READINGS - COMPLETE TEST STATION:")
        print("-"*70)
        ...
        if self.stage >= 3:
            try:
                ...
                print(f"  Waveform: {awg_data['waveform']} (SW1: {awg_data['sw1']}, SW2: {awg_data['sw2']})")
    ...
    def run_demonstration(self):
        ...
        print("\n" + "="*60)
        print("RUNNING COMPLETE TEST STATION DEMONSTRATION")
        print("="*60)
    ...
    # ========================================================================
    # MAIN OPERATION MODES - STAGE 4 COMPLETE
    # ========================================================================
    ...
    def run_combined_mode(self):
        ...
        # Update display with split-screen
    ...
    def run_test_station_with_menu(self):
        ...
        print(f"\n=== STARTING COMPLETE TEST STATION (STAGE {self.stage}) ===")
        self.show_main_menu()
...
def test_stage_4_complete():
    """Stage 4: Complete test station with all features"""
    print("\n" + "="*70)
    print("STAGE 4 TEST: COMPLETE INTEGRATED TEST STATION")
    print("="*70)
    print("This is the final stage with all features:")
    ...
    print("\nThis is a complete, professional-grade test station!")
    print("Commands: s=cycle modes, both=simultaneous, demo=demonstration")
    print("="*70)
...
if __name__ == "__main__":
    ...
    print("COMPLETE IMPLEMENTATION - STAGE 4")
    ...
    print("- GP20/GP21: DIP switches (waveform)")
    print("- GP26: Frequency potentiometer")
    ...
    print("- Manual frequency override")
    print("- Split-screen display")
    print("- Terminal menu control")
    print("- Demonstration mode")
    
    # Run the complete Stage 4 test station
